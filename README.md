...
- In case of LS, if you use virtual environment, just install the server into your virtual environment (e.g., using `pip install ruff`). Or just use [vim-lsp-settings](https://github.com/mattn/vim-lsp-settings) to manage LS.
